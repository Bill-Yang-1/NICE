...
from src.testing.testing_surgery import SurgeryTesterAutoDecoder
...
tester = SurgeryTesterAutoDecoder(decoder_surgery, decoder_shape, CFG, device, val_dataset, output_fd)
