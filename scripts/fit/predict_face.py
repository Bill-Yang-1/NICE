...
from src.testing.predict_surgery import SurgeryPredictAutoDecoder
...
val_dataset = SurgeryDataLoader(datapath=TEST_FOLDER,
...
tester = SurgeryPredictAutoDecoder(decoder_surgery, decoder_shape, CFG, device, val_dataset, output_fd)

tester.test_model(50)
